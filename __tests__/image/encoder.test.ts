...
describe('clamp255 edge cases', () => {
  ...
  test('handles extreme luminance values with Floyd-Steinberg', () => {
    const rgba = new Uint8Array([
      255, 255, 255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 127, 127, 127, 255, 128,
      128, 128, 255, 129, 129, 129, 255, 126, 126, 126, 255,
    ]);
  ...
  test('handles negative overflow cases', () => {
    const rgba = new Uint8Array([
      255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1, 1, 1, 255,
      2, 2, 2, 255, 3, 3, 3, 255, 4, 4, 4, 255,
    ]);
